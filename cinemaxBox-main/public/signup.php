...
<div class="d-flex justify-content-center">
        ...
        <img width="10px" height"10px" src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/70/Solid_white.svg/2048px-Solid_white.svg.png"></img>
        ...
        ">
            ...
            <form id="form-signup" class="needs-validation">

                <div class="form-group was-validated">
                <label class="form-label" for="text"></label>
                    <input id="name" class="form-control" placeholder="Nombre" type="text" name="name" required>
                    <div class="invalid-feedback">ingrese su nombre</div>
                </div>

                <div class="form-group was-validated">
                <label class="form-label" for="text"></label>
                    <input id="lastname" class="form-control" placeholder="Apellido" type="text" name="lastname" required>
                ...
                <div class="form-group was-validated">
                <label class="form-label" for="text"></label>
                    <input id="confirmed" class="form-control" placeholder="Confirmar clase" type="password" name="confirmed" required>
                    <div class="invalid-feedback">confirmar clase</div>
                </div>
                <br>
        ...
        <img style="width: 500px; height: 400px; margin-top: 150px;" src="https://static.vecteezy.com/system/resources/previews/005/992/382/original/night-cinema-movie-premiere-screen-with-friends-sitting-together-on-red-chairs-watching-a-film-in-flat-design-background-illustration-vector.jpg"></img>
    ...
    ">
      ...
      <div>
        ...
        text-decoration: none;
            ...
            <a href="https://www.linkedin.com/login" target="_blank" class="text-white enlace-ampliado" style="margin-top:0px;"><span class="ld"><i class="fa-brands fa-linkedin"></i></span></a>
